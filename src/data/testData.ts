    ...
    results: [
      {
        ...
        details:
          'Bạn đang làm rất tốt việc quản lý cảm xúc của mình. Những cảm giác buồn thoáng qua là hoàn toàn bình thường. Hãy tiếp tục duy trì lối sống lành mạnh, tập thể dục đều đặn và kết nối với mọi người xung quanh để giữ vững tinh thần tích cực này.',
      },
      {
        min: 10,
        max: 19,
    ...
    results: [
      {
        ...
        details:
          'Bạn kiểm soát lo âu khá tốt. Để duy trì, hãy thử tập thiền định 10 phút mỗi ngày. Hãy nhớ rằng lo âu là phản ứng tự nhiên giúp ta cảnh giác, miễn là nó không cản trở cuộc sống hàng ngày của bạn.',
      },
      {
        min: 10,
        max: 19,
      ...
      },
      {
        ...
        details:
          'Mức độ lo âu này có thể gây ra các cơn hoảng loạn (Panic Attack) và suy nhược cơ thể. Bạn cần sự can thiệp của chuyên gia để học cách kiểm soát và dùng thuốc nếu cần thiết. Đừng chịu đựng một mình.\n\nĐịa chỉ hỗ trợ chuyên sâu:',
        medicalContacts: [
          {
            name: 'Phòng khám Tâm thần kinh - BV Đại học Y Hà Nội',
            address: 'Số 1 Tôn Thất Tùng, Đống Đa, Hà Nội',
            phone: '19006422',
            coordinate: { latitude: 21.0026, longitude: 105.8306 },
          },
          {
            name: 'Viện Tâm lý Việt - Pháp',
            address: '46 Trần Quốc Vượng, Cầu Giấy, Hà Nội',
            phone: '0977729396',
            coordinate: { latitude: 21.0368, longitude: 105.7836 },
          },
          {
            name: 'Khoa Tâm thần - Bệnh viện Nguyễn Tri Phương',
            address: '468 Nguyễn Trãi, Phường 8, Quận 5, TP.HCM',
            phone: '02839234332',
            coordinate: { latitude: 10.7554, longitude: 106.6738 },
          },
        ],
      },
    ],
    ...
    results: [
      {
        ...
        details:
          'Bạn có kỹ năng quản lý thời gian và cảm xúc tuyệt vời. Hãy chia sẻ bí quyết của bạn với người khác nếu có thể! Để tối ưu hơn, hãy thử học thêm một kỹ năng mới hoặc môn thể thao mới để não bộ luôn được kích thích tích cực.',
      },
      {
        min: 13,
        max: 20,
      ...
      },
      {
        ...
        medicalContacts: [
          ...
          },
          {
            ...
            phone: '19006295',
            coordinate: { latitude: 10.7937, longitude: 106.7214 },
          },
        ],
      },
    ],
