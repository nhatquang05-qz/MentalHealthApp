        ...
        {currentSong ? (
          <View style={[styles.playerCard, { backgroundColor: colors.card }]}>
            ...
            <View style={{flex: 1, marginHorizontal: 12}}>
                ...
                <Text style={[styles.playerArtist, { color: colors.subText }]}>{currentSong.artist}</Text>
            </View>
            ...
            {musicCategories[activeTab]?.map((song: any) => (
                <TouchableOpacity 
                    ...
                    style={[
                      ...
                      currentSong?.id === song.id && { borderWidth: 1, borderColor: colors.primary, backgroundColor: isDark ? '#333' : '#F0F9FF' }
                    ]}
                    onPress={() => togglePlay(song)}
                >
                    <View style={[styles.playIconBox, { backgroundColor: isDark ? '#333' : colors.iconBg }]}>
                        <Ionicons 
...
const styles = StyleSheet.create({
  ...
  diskIcon: { width: 50, height: 50, borderRadius: 25, justifyContent: 'center', alignItems: 'center' },
  ...
  playIconBox: { width: 32, height: 32, borderRadius: 16, justifyContent: 'center', alignItems: 'center' },
